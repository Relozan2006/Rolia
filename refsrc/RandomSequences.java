...
public class RandomSequences extends SavedData {
    ...
    private RandomSequence createSequence(
        ...
        long seed = (includeWorldSeed ? io.rolia.secureseed.Globals.transformSeed(worldSeed, 0x524C4F4F54L) : 0L) ^ salt; // Rolia - do not leak the raw level seed through loot random sequences
